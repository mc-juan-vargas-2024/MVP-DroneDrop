<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Rol -->
        <div class="mt-4">
            <x-input-label for="role" :value="__('Registrarte como')" />
            <select id="role" name="role" class="block mt-1 w-full border-gray-300 focus:border-orange-500 focus:ring-orange-500 rounded-md shadow-sm" required>
